...
@Component({
  selector: 'azure-devops-content',
  templateUrl: './azure-devops-content.component.html',
  styleUrls: ['./azure-devops-content.component.css']
})
export class AzureDevOpsContentComponent {
