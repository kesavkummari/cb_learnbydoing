...
@Component({
  selector: 'data-analyst-course',
  templateUrl: './data-analyst-course.component.html',
  styleUrls: ['./data-analyst-course.component.css']
})
export class DataAnalystCourseComponent {
